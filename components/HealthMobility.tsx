        ...
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full p-4 bg-gradient-to-t from-background/80 via-background/50 to-transparent">
                 <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-gray-100">Health Mobility</h1>
                    <p className="text-lg text-gray-600 dark:text-gray-300">Book transport for hospital visits.</p>
                </div>
                <Tabs defaultValue="ambulance" className="w-full max-w-md">
                    <TabsList className="grid w-full grid-cols-2">
                        <TabsTrigger value="ambulance">Book Ambulance</TabsTrigger>
                        <TabsTrigger value="transport">Book a Ride</TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="ambulance">
                        <Card className="bg-background/80 backdrop-blur-sm">
                            <CardHeader>
                                ...
                                <CardDescription>Your location will be sent automatically.</CardDescription>
                            </CardHeader>
                            <CardContent>
