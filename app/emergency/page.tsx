...
import { Ambulance, ShieldAlert, Flame, MessageSquare, Map as MapIcon, Siren } from 'lucide-react';
    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-red-600 mb-4">Emergency Services</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">Instant access to vital emergency support when you need it most.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {emergencyServices.map((service, i) => (
            <Card
              ...
              className="cursor-pointer bg-white dark:bg-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
            >
              <CardHeader className="flex flex-row items-center gap-4">
                <div className="bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 p-3 rounded-full">
                  <service.icon className="w-6 h-6" />
                </div>
                <CardTitle className="font-semibold text-xl text-gray-800 dark:text-gray-100">{service.title}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <div id="map-container" className="mt-16 pt-8 border-t dark:border-gray-700">
           <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-gray-100 mb-6">Your Live Location</h2>
           <p className="text-center text-gray-500 dark:text-gray-400 mb-6">Note: Map functionality requires location permissions.</p>
